...
def lever():
    ...
    body = hull()(upper_body + trans(0, lever_h, 0, lower_body))
    return pivot + trans(0, lever_h - eps, clearance, stopper) + body
...
if __name__ == '__main__':
    ...
    scad_render_to_file(p3, 'lever.scad', file_header='$fn = %s;' % SEGMENTS, include_orig_code=False)
